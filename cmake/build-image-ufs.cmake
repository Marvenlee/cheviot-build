...
add_custom_target ( image-ufs                  
#                     COMMAND pseudo ${CMAKE_CURRENT_SOURCE_DIR}/tools/copy-rpi-binary-blobs.sh 
                     COMMAND pseudo ${CMAKE_CURRENT_SOURCE_DIR}/cheviot-build/mk-kernel-img-ufs.sh 
                     COMMAND pseudo ${CMAKE_CURRENT_SOURCE_DIR}/cheviot-build/mk-sdcard-image-ufs.sh 
